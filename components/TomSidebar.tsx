...
import { LayoutDashboard, Users, Briefcase, TrendingUp, X, LogOut, Shield, Briefcase as UserIcon } from 'lucide-react';
...
const TomSidebar: React.FC<SidebarProps> = ({ 
  currentView, 
  setCurrentView, 
  currentCycle, 
  setCurrentCycle, 
  ...
  const navItems = [
    ...
    { id: 'pillar1', label: 'Pijler 1: Opkomst', icon: Users },
    { id: 'pillar2', label: 'Pijler 2: Bezoeken', icon: Briefcase },
    { id: 'pillar3', label: 'Pijler 3: Groei', icon: TrendingUp },
  ];
